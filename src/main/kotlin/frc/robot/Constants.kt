...
object Constants {
    ...
    // feed forwards
    const val DRIVE_KS_R = 0.31568
    const val DRIVE_KV_R = 0.13272
    const val DRIVE_KA_R = 0.0091552

    const val DRIVE_KS_L = 0.26459
    const val DRIVE_KV_L = 0.13066
    const val DRIVE_KA_L = 0.0071033
